...
export async function geminiResponse(command,assistantName,userName) {
  try {
    ...
    Type meanings:
    "general": if it's a factual or informational question,aur agar koi aisa question puche 
    jiska answer tumhe ata hai usko bhi general ki categary me rakhna answer short dena
